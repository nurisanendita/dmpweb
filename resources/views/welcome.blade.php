          ...
          <div class="container mySlides col-md-12 col-lg-12 w3-animate-right" id="slide1">
            ...
            @foreach ($agenda as $agenda_list)
                  ...
                  <div class="info-box-content" style="margin-left:30px;">
                    <span class="info-box-text" style="font-size:18px; ">{{date('M Y'($agenda_list->tanggal_acara))}}</span>
                    <span class="info-box-number" style="font-size:30px; ">{{date('d'($agenda_list->tanggal_acara))}}</span>
                  </div>
                  </div>
                </div>
