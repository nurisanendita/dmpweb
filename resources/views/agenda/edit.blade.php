...
<form action="{{ url('/') }}/agenda_edit/{{$agenda->id}}" method="post">
	...
	<b>Tampilkan</b>
	<input style="margin-left:50px;" type="radio" name="input_ditampilkan" value="{{$agenda->ditampilkan==1}}" checked="1">Ya
	<input style="margin-left:30px;" type="radio" name="input_ditampilkan" value="{{$agenda->ditampilkan==0}}" checked="0">Tidak<br><br>
