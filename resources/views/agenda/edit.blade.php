...
<form action="{{ url('/') }}/agenda_edit/{{$agenda->id}}" method="post">
	...
	<b>Tampilkan</b>
	<input style="margin-left:50px;" type="radio" name="input_ditampilkan" checked="{{$agenda->ditampilkan==1}}">Ya
	<input style="margin-left:30px;" type="radio" name="input_ditampilkan" checked="{{$agenda->ditampilkan==0}}">Tidak<br><br>
